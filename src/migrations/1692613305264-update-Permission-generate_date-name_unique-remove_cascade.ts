...
export class UpdatePermissionGenerateDateNameUniqueRemoveCascade1692613305264
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "permission" ALTER COLUMN "deletedAt" DROP NOT NULL`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "permission" ALTER COLUMN "createdAt" DROP DEFAULT`,
    );
    await queryRunner.query(
